...
const Detalle = ({seleccionado, onGuardar, catalogo}) => {
    ...
    const guardarRegistro = () => {
        guardaGenerico('tipo_muestra', registro)
            .then(res => {
                cerrarAlert();
                onGuardar(registro);
            })
        ...
        <div className="card border-tabla z-depth-2">
            ...
            <div className="m-2">
                ...
                <div className="d-flex mb-2 mt-1">
                    <span className="py-0 pr-3 mt-1 text-nowrap">{i18next.t('catalogos:tipoPM')}:</span>
                    <Select onSelect={e => setRegistro({...registro, tipo_pm: e})}
                            selected={registro.tipo_pm}
                            options={catalogo}
                            labelKey="nombre"/>
                </div>
                <div className="d-flex mb-2 mt-1">
                ...
                <div className="mt-3">
                    <Boton
                        ...
                        posicion={'right'}
                        habilitado={propiedadValida(registro, 'nombre') && can('catalogos.guardar_tipo_muestra')}
