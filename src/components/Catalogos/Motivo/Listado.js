                ...
                <div id="div_tabla">
                    <table className=" table table-condensed responsive hover ">
                        ...
                        {(registros || []).map((reg, idx) => <tr key={idx}>
                            <td>{reg.tipo==="RES"?i18next.t('catalogos:rechazo'):i18next.t('catalogos:desbloqueo')}</td>
                            <td>{reg.nombre}</td>
    ...
    return (
        ...
        <tr>
            <th className='text-center cursor'
                ...
                <IconosSort key_sort={'tipo'} key_actual={sort.key} order={sort.order}/>
                {i18next.t('catalogos:tipo')}
            </th>
            <th className='text-center cursor'
...
const TheadBuscador = ({filtro, setFiltro}) => {
    return (
        ...
        <tr>
            <th className='py-1'>
                <input className='form-control form-control-sm' value={filtro.tipo || ""}
